...
#ifndef AICAMERA_58F32CD596303AFFB95BF2E1876196AA268A717B_BOUNDINGBOX_H
#define AICAMERA_58F32CD596303AFFB95BF2E1876196AA268A717B_BOUNDINGBOX_H
...
namespace FaceInception {
    ...
    */
    Mat cropImage(Mat& input_image, Rect2d roi, Size2d target_size, int flags = 1, int borderMode = 0, Scalar borderValue = Scalar(0)) {
        ...
        M.at<float>(0,0)= target_size.width / roi.width;
        M.at<float>(0,1)=0;
        M.at<float>(0,2)=-roi.x*target_size.width / roi.width;
        M.at<float>(1,0)=0;
        M.at<float>(1,1)=target_size.height / roi.height;
        M.at<float>(1,2)=-roi.y*target_size.height / roi.height;
        //std::cout << M << std::endl;
        Mat result;
...
#endif //AICAMERA_58F32CD596303AFFB95BF2E1876196AA268A717B_BOUNDINGBOX_H
